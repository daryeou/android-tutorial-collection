package kr.feliz.tutorial_collection.korbit.widget
...
import kr.feliz.tutorial_collection.korbit.widget.KorbitDashboardWidget.Companion.TAG
 ...
 */
class KorbitDashboardWidget : AppWidgetProvider() {
    companion object{
        val TAG: String = "KorbitDashboardWidget"
    ...
    override fun onAppWidgetOptionsChanged(
        ...
        Log.d(TAG, "KorbitDashboardWidget - 위젯 ${width} ${height}")

        val widgetWidth = round(width * density)
        val widgetHeight = round(height * density)
        Log.d(TAG, "KorbitDashboardWidget - 위젯 pixel ${widgetWidth} ${widgetHeight}")
    }
}
...
internal fun updateAppWidget(
    ...
    val views = RemoteViews(context.packageName, R.layout.widget_korbit_dashboard)

    val widgetText = context.getString(R.string.korbit_app_widget)
